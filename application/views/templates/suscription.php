<script type="text/ng-template" id="suscription.html">
    ...
    <div class="modal-footer" ng-if="!(sustecritedSucces && hasSuscription)">
        <button type="button" class="btn btn-primary" ng-disabled="suscriptionForm.$invalid" ng-click="ok( email )">¡Suscribirme ahora!</button>
    </div>
</script>
