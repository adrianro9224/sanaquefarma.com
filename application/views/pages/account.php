		...
		<section id="content">
			<div  class="container">
				<div class="row">
                    ...
                    <div class="col-md-3">
                        <p id="benefits-banner" class="bg-info">Recibe puntos al registrarte y al realizar cualquier compra. Además te enviaremos información de promociones y descuentos, tips de salud, noticias y mucho más.</p>
                    </div>
                </div>
                <div class="row">
