...
class Mandrill_lib {
	...
	public function send_suscription_email( $account ){
...
*/
            ...
            $template_name = 'suscriptionPromo';
            ...
            $message = array(
                ...
                'subject' => '¡Gracias por suscribirte a nuestro boletín de noticias!',
                'from_email' => 'suscripcion@sanaquefarma.com',
                'from_name' => 'Equipo sanaquefarma.com',
                'to' => array(
                    array(
                        'email' => $account->email,
